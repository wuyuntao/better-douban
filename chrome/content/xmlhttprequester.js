function betterdouban_xmlhttpRequester(unsafeContentWin, chromeWindow)  {
...
betterdouban_xmlhttpRequester.prototype.contentStartRequest = function(details)  {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				betterdouban_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
betterdouban_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
betterdouban_xmlhttpRequester.prototype.setupRequestEvent =
